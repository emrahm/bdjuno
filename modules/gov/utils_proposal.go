...
func (m *Module) updateProposalStatus(proposal v1beta1.Proposal) error {
	return m.db.UpdateProposal(
		types.NewProposalUpdate(
			proposal.ProposalId,
...
func (m *Module) updateProposalTallyResult(proposal v1beta1.Proposal) error {
...
func (m *Module) updateAccounts(proposal v1beta1.Proposal) error {
...
func (m *Module) handlePassedProposal(proposal v1beta1.Proposal, height int64) error {
	if proposal.Status != v1beta1.StatusPassed {
